...
import SelectDropdown, { OptionMenuList, OptionPropsList, components } from '@fajrindev/custom-select'
...
function App() {
  ...
  return (
    <div className="max-w-[800px] m-auto mt-[100px] h-[100px] bg-slate-500">
      <button
